...
<body>
    ...
    <div id="header">
			...
			$sql = "SELECT * FROM product A, category B
			...
			$id = $row['id'];
				...
				if( $row['status'] == 'active'&&$row['quantity']<1){
			echo "<div class='side-deal'>";
				echo "<h3><a href='deal.php=?$id'>".$row['title']."</a></h3>";	
				echo "<img class='side-deal-img' src='upload/".$row['pic']."'>";
				echo "<div>";
					echo "<h4>$".$row['price']."</h4>";
					echo "<p>Old price <del>$".$row['oldprice']."</del></p>";
				echo "</div>";
				echo "<a class='read-deal' href='product.php?productId=$id' >More detail</a>";
				echo "<ul class='side-deal-count'>";
				echo "<li>Quantity<span>".$row['quantity']."</span></li>";
				echo "<li class='end'>Due date<span  class='timeinput' title='1871694' >".$row['date']."</span></li>";
