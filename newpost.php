...
<body>
    ...
    <div id="header">
            ...
            <form action='post.php' method='post' enctype="multipart/form-data" id='newPost'>
            <h1>New-post</h1>
            ...
            <textarea id='describe' name='describe' rows='10' col='65'> </textarea>
			
			<label>Due date
			<span class="small"></span>
			</label>
			<input name="strdate" type="text" id='strdate'/>*(dd/mm/yyyy)
